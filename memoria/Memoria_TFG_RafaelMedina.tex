...
La seguridad de la plataforma ha sido tratada como un requisito transversal de primer orden, no como un añadido posterior. Se realizó un análisis sistemático de vulnerabilidades siguiendo el estándar OWASP Top 10 y se aplicaron contramedidas específicas en cada capa de la arquitectura. El resultado es una batería de veinticinco pruebas de seguridad automatizadas integradas en el pipeline de CI/CD que validan las medidas implementadas en cada build.
