...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String input) throws UsernameNotFoundException {
        ...
        Usuario usuario = userRepository.findUsuarioByEmail(input)
        ...
        log.debug("Cargando usuario: input={}, email={}, activo={}, roles={}", input, usuario.getEmail(),
                usuario.getActivo(), authorities);
